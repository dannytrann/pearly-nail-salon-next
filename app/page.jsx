...
export default function ServiceMenu() {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm tracking-wide">Loading services...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <div className="relative border-b border-secondary/30 bg-gradient-to-r from-secondary/10 via-white to-primary/5">
        <div className="container-custom py-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
              <p className="text-secondary font-medium text-sm tracking-widest uppercase mb-2">Welcome to Pearly</p>
            ...
            <div className="flex flex-col gap-3 sm:items-end">
              ...
              <a
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full border border-secondary/50 bg-white/80 text-neutral-750 hover:bg-secondary/20 hover:border-secondary transition-all duration-300 text-sm font-medium tracking-wide"
              >
              ...
              <Link
                href="/group-booking"
                className="group inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white px-8 py-3.5 rounded-full font-medium transition-all duration-300 text-sm tracking-wide shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5"
              >
          ...
          <div className="space-y-20">
            {sortedCategories.map(([categoryName, categoryServices], index) => (
              <section key={categoryName} className="relative">
                ...
                {index % 2 === 1 && (
                  <div className="absolute -inset-x-4 -inset-y-8 bg-gradient-to-r from-secondary/5 via-secondary/10 to-secondary/5 rounded-3xl -z-10"></div>
                )}

                {/* Category Header */}
                <div className="flex items-center gap-4 mb-10">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 text-primary">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 h-0.5 bg-gradient-to-r from-primary/50 via-secondary/50 to-transparent rounded-full"></div>
                  </div>
                </div>
                ...
                {index < sortedCategories.length - 1 && (
                  <div className="flex items-center justify-center mt-16">
                    ...
                    <div className="mx-4 w-2 h-2 rounded-full bg-secondary/50"></div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-block">
            <div className="flex items-center justify-center mb-4">
              ...
              <div className="mx-3 text-secondary text-xl">✦</div>
              <div className="h-px w-12 bg-gradient-to-l from-transparent to-secondary/50"></div>
            </div>
            <p className="text-gray-400 text-sm tracking-wide mb-6">Ready to treat yourself?</p>
            <div className="flex flex-col gap-3 items-center">
              ...
              <Link
                href="/group-booking"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-primary-dark text-white px-10 py-4 rounded-full font-medium transition-all duration-300 text-sm tracking-wide shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5"
              >
...
function ServiceItem({ service }) {
  return (
    <div className="group relative border border-gray-200 rounded-xl p-5 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 bg-white overflow-hidden">
